...
Future<Client> addClient(Client client) async {
  var url = Uri.parse('http://192.168.100.4:4000/api/clientes/registro');
...
Future<Client> deleteClient(String clientId) async {
  ...
  final http.Response response = await http.delete(
    Uri.parse('http://192.168.100.4:4000/api/clientes/eliminar/$clientId'),
...
Future<Client> modifyClient(Client client) async {
  var url = Uri.parse('http://192.168.100.4:4000/api/clientes/modificar');
